...
export declare interface LocationMetadata {
    /**
...
export declare type LocationType = "Region" | "EdgeZone";
...
export declare interface PairedRegion {
    /**
 ...
 * **Other**
 */
export declare type RegionCategory = string;
 ...
 * **Logical**
 */
export declare type RegionType = string;
