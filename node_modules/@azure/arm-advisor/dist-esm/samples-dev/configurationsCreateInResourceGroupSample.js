...
function putConfigurations() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.configurations.createInResourceGroup(configurationName, resourceGroup, configContract);
        console.log(result);
    });
}
putConfigurations().catch(console.error);
//# sourceMappingURL=configurationsCreateInResourceGroupSample.js.map